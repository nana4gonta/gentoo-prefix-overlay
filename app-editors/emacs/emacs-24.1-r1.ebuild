...
# $Header: /var/cvsroot/gentoo-x86/app-editors/emacs/emacs-24.1-r1.ebuild,v 1.1 2012/08/13 08:09:54 ulm Exp $
...
src_prepare() {
	...
	if [[ ${CHOST} == *-darwin* ]] ; then
		cd "${S}"
		epatch "${FILESDIR}/emacs-inline.patch" \
		"${FILESDIR}/emacs-24.1-lion-fullscreen.patch"
	fi
