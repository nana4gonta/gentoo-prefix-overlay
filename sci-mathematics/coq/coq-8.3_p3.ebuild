...
# $Header: /var/cvsroot/gentoo-x86/sci-mathematics/coq/coq-8.3_p3.ebuild,v 1.1 2011/08/13 12:53:00 tomka Exp $
...
src_install() {
	emake STRIP="true" COQINSTALLPREFIX="${ED}" install || die
